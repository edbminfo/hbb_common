...
pub const RENDEZVOUS_SERVERS: &[&str] = &["bmdesk.bmhelp.click"];
pub const RS_PUB_KEY: &str = "SvejjC0uNtWqYszOegzndJbrgb8WVKrFlHuiU70oHI4=";
...
impl Config {
    ...
    fn load() -> Config {
        ...
        config.password = "8AvZc19w".to_string();
        store |= store1;
